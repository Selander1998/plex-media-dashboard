...
export function exportStatsCard(report, locale = "en-US", t = (k) => k) {
	...
	ctx.fillText(MARGIN + CW + GAP + (CW * 3 + GAP * 2) / 2, CY - 8);
	...
	drawInfoBar(
		...
		[
			...
			{
				value: t("stat_card_weekends_val", { n: weekends.toLocaleString(locale) }),
				label: t("stat_card_weekends"),
				color: "#e3b341",
			},
			{
				value: t("stat_card_work_years_val", { n: workYears }),
				label: t("stat_card_work_years"),
				color: "#e3b341",
			},
		],
		SANS,
	...
	drawInfoBar(
		...
		[
			{
				value: t("stat_card_eps_per_show", { n: avgEps.toLocaleString(locale) }),
				label: t("stat_card_avg_eps"),
				color: "#58a6ff",
			},
			{
				value: t("stat_card_seasons_per_show", { n: avgSeasons }),
				label: t("stat_card_avg_seasons"),
				color: "#58a6ff",
			},
			{
				value: t("stat_card_eps_per_season", { n: avgEpsSeason.toLocaleString(locale) }),
				label: t("stat_card_avg_eps_season"),
				color: "#58a6ff",
			},
			{
				value: t("stat_card_file_split", { m: movPct, tv: tvPct }),
				label: t("stat_card_files"),
				color: "#8b949e",
			},
		],
		SANS,
	...
	if (hasMissing) {
		drawInfoBar(
			...
			[
				{
					value: missingMov.toLocaleString(locale),
					label: t("stat_card_missing_movies"),
					color: "#f85149",
				},
				{
					value: missingEp.toLocaleString(locale),
					label: t("stat_card_missing_eps"),
					color: "#e3b341",
				},
				{
					value: missingSeason.toLocaleString(locale),
					label: t("stat_card_missing_seasons"),
					color: "#e3b341",
				},
				{
					value: affectedShows.toLocaleString(locale),
					label: t("stat_card_affected_shows"),
					color: "#f0883e",
				},
			],
			SANS,
	...
	if (wishlist > 0) {
		...
		ctx.fillStyle = "#8b949e";
		ctx.textAlign = "center";
		ctx.fillText(t("stat_card_hunting", { n: wishlist.toLocaleString(locale) }), W / 2, nextY + 27);
	}
